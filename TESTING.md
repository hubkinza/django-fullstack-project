...
| Checked | ...**Easily navigate the admin panel** so that **I can view, search, add and delete Books** |
|:-------:|:--------|
| &check; | Can add a Book |
| &check; | Can delete an individual Book |
| &check; | Can delete multiple Books at once |
| &check; | Can view a Book post |

| Checked | ...**Edit a book without using the admin panel** to that **if I spot a mistake or update a book, I can do so quickly and easily without issue.** |
|:-------:|:--------|
...
| Checked | ...**register for an account** so that **I can enjoy a personalized experience as a Book Lover** |
|:-------:|:--------|
...
| Checked | ...**Are prompted to signup to browse the available books 
|:-------:|:--------|
| &check; | Can see the browse books Button  |
| &check; | Browse books Button redirects to sign up page |
| &check; | Can see I need to sign up/log in to see more info |

## As a **Registered User** I can... 

| Checked | ...**browse the full details of the available books** so that **I can see the full book spec ** |
|:-------:|:--------|
| &check; | Access All available books   |

| Checked | ...**Add books to a Wishlist** so that **I can refer back to them later with minimal effort** |
|:-------:|:--------|
| &check; | Can pin a book to wishlist post from the details page  |
| &check; | Once pinned, they are visible on the wishlist page |
| &check; | Wishlist books are visible only to the user who pinned them  |
| &check; | Can unpin a book from the wishlist page  and it disappears from this view |


| Checked | ...**delete books from their wishlist ** so that **I can delete Books that are no longer relevant to me.** |
|:-------:|:--------|
| &check; | Removee button visible from the Wishlist page  |
| &check; | Entry disappears from the wishlist Removal  |
...
| &check; | Add Book form is responsive from 320px up |
| &check; | Wishlist  page is responsive from 320px up |
| &check; | Book details page is responsive from 320px up |
| &check; | Browse books page is responsive from 320px up |
...
| &check; | When logged out, only the landing page, and all auth pages are visible|
